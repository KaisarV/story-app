...
import com.kai.storyapp.DataDummy
import com.kai.storyapp.MainDispatcherRule
import com.kai.storyapp.adapter.ListStoryAdapter
import com.kai.storyapp.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        `when`(storyRepository.getStoryData()).thenReturn(expectedStory)
    ...
    fun `when Get Story Empty Should Return No Data`() = runTest {
        ...
        `when`(storyRepository.getStoryData()).thenReturn(expectedQuote)
        val mainViewModel = HomeViewModel(storyRepository)
        val actualStory: PagingData<ListStoryItem> = mainViewModel.story.getOrAwaitValue()
        val differ = AsyncPagingDataDiffer(
            diffCallback = ListStoryAdapter.DIFF_CALLBACK,
